...
describe('Search functionality', () => {
	...
	const testData = [
		{ searchPhrase: 'Juventus', productName: 'Juventus Home Jersey 2019 2020', size: 'L' },
		{ searchPhrase: 'Bayern', productName: 'Bayern Munich Home Koszule 2019 2020', size: '7-8' },
	];

	testData.forEach(data => {
		it(`should allow to search for '${data.searchPhrase}' products and order '${data.productName}'`, () => {
